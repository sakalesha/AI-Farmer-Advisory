...
- [x] Implement i18next for localization
- [x] Add support for Hindi/Kannada/Local languages
- [ ] Voice-based input support (B3 - Next)

### Phase 2.5 · Community & Knowledge Sharing (B2)
- [x] Develop "Post to Community" social features
- [x] Global Feed with CRUD & Like interaction
- [x] Multi-language support for social feed
...
- [x] Add **NDVI Satellite Layer** (Sentinel-2 Mock Integration)
- [ ] Implement **Professional PDF Report Export** (A2 - Planned)
- [ ] Enable **Offline Support (PWA)** for rural use

### Phase 6 · Stability & Monorepo DX
- [x] Monorepo restructuring (`npm run full-stack`)
- [x] Windows / Unicode compatibility fixes
- [x] Backend Controller refactor (Robust Error Handling)
- [x] Frontend View integrity (Satellite/Community fixes)
