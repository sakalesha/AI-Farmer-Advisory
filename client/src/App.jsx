                    ...
                    {history.map((item, index) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-4 text-[10px] font-bold text-slate-400">
                          <span className="flex items-center gap-1"><Zap className="w-3 h-3" /> N:{item.inputs.N}</span>
                          <span className="flex items-center gap-1"><Wind className="w-3 h-3" /> H:{item.inputs.humidity}%</span>
                        </div>
